...
{
    public class TransListRequest : YuanpayRequest<TransListResponse>
    {
        ...
        public override TransListResponse convertResponse(string ret)
        {
            TransListResponse response = new TransListResponse();
            JObject json = JObject.Parse(ret);
            //if (json.GetValue("transactions") != null)
            //{
            //    response.transactions = JArray.Parse(json.GetValue("transactions").ToString());
            //}
