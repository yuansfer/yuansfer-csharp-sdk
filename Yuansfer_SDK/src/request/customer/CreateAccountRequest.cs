...
{
    public class CreateAccountRequest : YuanpayRequest<CreateAccountResponse>
    {
        ...
        protected override string getAPIUrl(string env)
        {
            ...
            string url = urlPrefix + RequestConstants.CUSTOMER_CREATE_ACCOUNT;
            return url;
        }

        //Handle response data
        public override CreateAccountResponse convertResponse(string ret)
        {
